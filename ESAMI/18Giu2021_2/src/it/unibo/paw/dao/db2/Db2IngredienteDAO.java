...
public class Db2IngredienteDAO implements IngredienteDAO {
	...
	static final String TABLE = "Ingrediente";
	...
	static final String insert = "INSERT " + "INTO " + TABLE + " ( " + ID + ", " + NOME + ", " + QUANTITA + ") "
			+ "VALUES ( ?,?,?) ";
	...
	static final String update = "UPDATE " + TABLE + " " + "SET " + NOME + " = ? " + QUANTITA + " = ? " + "WHERE " + ID
			+ " = ? ";
...
// ------------------- METODI DAO -----------------------
	public void create(IngredienteDTO ingrediente) {
		...
		try {
			...
			prep_stmt.setString(2, ingrediente.getNome());
...
// -------------------------------------------------------------------------------------
	...
	public Db2IngredienteDTOProxy read(int id) {
		Db2IngredienteDTOProxy result = null;
		if (id < 0) {
		...
		try {
			...
			if (rs.next()) {
				Db2IngredienteDTOProxy entry = new Db2IngredienteDTOProxy();
