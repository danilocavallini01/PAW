...
public class Db2SquadraPallacanestroDAO implements SquadraPallacanestroDAO {
	...
	static final String TABLE = "Squadrapallacanestro";
	...
	static final String ALLENATORE = "allenatore";

	// == STATEMENT SQL
	// ====================================================================

	// INSERT INTO table ( name,description, ...) VALUES ( ?,?, ... );
	static final String insert = "INSERT " + "INTO " + TABLE + " ( " + ID + ", " + NOME + ", " + TORNEO + ", "
			+ ALLENATORE + ") " + "VALUES (?,?,?,?) ";
	...
	static final String update = "UPDATE " + TABLE + " " + "SET " + NOME + " = ? " + TORNEO + " = ? " + ALLENATORE
			+ " = ? " + "WHERE " + ID + " = ? ";

	// -------------------------------------

	static final String create = "CREATE " + "TABLE " + TABLE + " ( " + ID + " INT NOT NULL PRIMARY KEY, " + NOME
			+ " VARCHAR(50) NOT NULL, " + TORNEO + " VARCHAR(50) NOT NULL, " + ALLENATORE + " VARCHAR(50), " + "UNIQUE("
			+ NOME + "," + TORNEO + ")" + ")";
...
// ------------------- METODI DAO -----------------------
	public void create(SquadraPallacanestroDTO squadrapallacanestro) {
		...
		try {
			...
			prep_stmt.setString(2, squadrapallacanestro.getNome());
			prep_stmt.setString(3, squadrapallacanestro.getTorneo());
			prep_stmt.setString(4, squadrapallacanestro.getAllenatore());

			prep_stmt.executeUpdate();

			squadrapallacanestro.setId(id);
...
// -------------------------------------------------------------------------------------
	...
	public boolean update(SquadraPallacanestroDTO squadrapallacanestro) {
		...
		try {
			...
			prep_stmt.setString(1, squadrapallacanestro.getNome());
			prep_stmt.setString(2, squadrapallacanestro.getTorneo());
			prep_stmt.setString(3, squadrapallacanestro.getAllenatore());
			prep_stmt.setInt(4, squadrapallacanestro.getId());
